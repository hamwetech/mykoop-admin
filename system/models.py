...
class MemberOrder(models.Model):
    ...
    created_by = models.ForeignKey(User, blank=True, on_delete=models.CASCADE, related_name='order_created_by')
    create_date = models.DateTimeField(auto_now_add=True)
    update_date = models.DateTimeField(auto_now=True)
...
class OrderItem(models.Model):
    ...
    created_by = models.ForeignKey(User, blank=True, on_delete=models.CASCADE, related_name='created_by')
    create_date = models.DateTimeField(auto_now_add=True)
    update_date = models.DateTimeField(auto_now=True)
